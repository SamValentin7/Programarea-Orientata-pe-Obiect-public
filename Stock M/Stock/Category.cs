    ...
    public partial class Category : Form
    {
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    SqlCommand cmd = new SqlCommand("insert into CategoryTbl values(@CatN,@Tel)", Con);
                    cmd.Parameters.AddWithValue("@CatN", CatNameTb.Text);
                    cmd.Parameters.AddWithValue("@Tel", tbTelefon.Text);
                    cmd.ExecuteNonQuery();
        ...
        private void editBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    SqlCommand cmd = new SqlCommand("Update CategoryTbl set Nume=@CN, Telefon=@Tel where IdCategorie=@CKey", Con);
        ...
        private void CategoryDGV_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                tbTelefon.Text = CategoryDGV.Rows[e.RowIndex].Cells[2].Value.ToString();
                if (CatNameTb.Text == "")
                {
                    key = 0;
                }
